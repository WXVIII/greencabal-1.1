...
import { Camera, Instagram, Youtube, Facebook, Percent, Mail, Bell, Shield, ExternalLink, Check, X as XMark } from 'lucide-react';
...
const Profile = () => {
  ...
  const { user, connectPlatform, disconnectPlatform, getDiscountInfo } = useAuth();
